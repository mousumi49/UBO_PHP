...
.dropdown:hover .dropdown-content {display: block; margin-top: 15px;}

.dropdown:hover .dropbtn { color:#ff8c00;}
</style>
<body>
        ...
        <li class="dropdown">
         ...
         <a href="#">Doctor Clinics</a>
           ...
           <li><a href="#">PARTNER WITH US</a></li>
            ...
            ?>
             <li><a href="cart.php"><span class="glyphicon glyphicon-shopping-cart"><span id="badge" style="background:#ff8c00;
         ...
         <div id="myCarousel" class="carousel slide carousel-fade" data-ride="carousel">
            ...
            <div class="carousel-inner">
                <div class="item active">
                    <img src="images/banner-lab-2.png"  style="width: 1350px; height: 80vh;" >
                </div>
                <div class="item">
                     <img src="images/new-banner.jpg" style="width: 1350px; height: 80vh;">
                </div>
                <div class="item">
                   <img src="images/banner-lab4may.jpg" style="width: 1350px; height: 80vh;">
                </div>
                <div class="item">
                     <img src="images/6th.gif" style="width: 1350px; height: 80vh;">
                </div>
                 <div class="item">
                     <img src="images/5th_1.gif" style="width: 1350px; height: 80vh;">
                </div>
