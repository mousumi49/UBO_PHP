...
<ul>
         ...
         <a href="#">Doctor Clinics</a>
           ...
           <li><a href="#">PARTNER WITH US</a></li>
            ...
            <li><a href="#"><span class="glyphicon glyphicon-calendar" ></span> Report</</a></li>
             <li><a href="mycart.php"><span class="glyphicon glyphicon-shopping-cart"></span><span id="badge" style="background:#ff8c00;
  ...
  <div class="top-nav-bar">
        ...
        <li><span class="glyphicon glyphicon-calendar" ></span><a href="#"> Test/ Package</</a></li>
             ...
             <li><a href="mycart.php"><span class="glyphicon glyphicon-shopping-cart"><span id="badge" style="background:#ff8c00;
    border-radius: 50%;font-size:15px;padding: 4px 7px 4px 5px"; >
    <?php if(isset($_SESSION["cart_qty"])){ 
      echo $_SESSION["cart_qty"];
    } else{ 
      echo "0";
...
<?php
  ...
  while($row = $result->fetch_assoc() ){
   ...
   <a href="front_package.php?id='.$row["id"].'" style="font-size:11px;">'.$row["ptitle"].'</a>
